  ...
  return (
    <div className="mb-10 w-full">
      <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl overflow-hidden shadow-xl border border-white/10">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-stretch gap-5 p-6 sm:p-8">
          ...
          <div className="flex-1 flex flex-col justify-center text-center sm:text-left min-w-0">
            ...
            {perfil.frase && (
              <p className="text-xs text-gray-300 italic mt-2 bg-white/5 border border-white/10 rounded-lg px-3 py-1.5">
                "{perfil.frase}"
              </p>
            )}
          ...
          <div className="flex-shrink-0 flex items-center justify-center">
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl border border-white/15 bg-white/10 backdrop-blur-sm flex items-center justify-center overflow-hidden shadow-lg">
