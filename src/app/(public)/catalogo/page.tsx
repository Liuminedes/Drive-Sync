    ...
    <div className="min-h-screen bg-[#fafafa] dark:bg-background selection:bg-primary/30">
      <header className="bg-background/80 backdrop-blur-md border-b border-border/40 sticky top-0 z-10 transition-all duration-300">
        <div className="max-w-7xl mx-auto flex items-center justify-between py-4 px-6 md:px-8">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-semibold tracking-tight">DriveSync</h1>
          </div>
          <div className="flex items-center gap-4">
            <span className="text-sm font-medium bg-muted/50 text-muted-foreground px-3 py-1 rounded-full border border-border/50">
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-8 py-12 md:py-16">
        <div className="mb-10 max-w-2xl">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-3">Descubre tu próximo vehículo</h2>
          <p className="text-muted-foreground text-lg">Explora nuestro inventario seleccionado de vehículos certificados, listos para que los conduzcas hoy mismo.</p>
        </div>

        {productos?.length === 0 ? (
          <div className="text-center py-32 bg-white dark:bg-muted/10 rounded-2xl border border-dashed border-border">
